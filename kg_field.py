...
# KG field
def run(pot0,x0,y0,r0,vx0,vy0,px0,py0):
    ...
    x0 = x0
    y0 = y0#-60
    px0 = px0/2 #mc   SO THIS IS ACTUALLY HALF MOMENTUM, 
    #                NEED TO ANALYZE HOW THE UNITS AND FACTORS OF 2 PLAYS EXACTLY
    py0 = py0#-sim.p_extent_hi*(1/6)
    a_gauss = 50
    ...
    cmap_str = 'seismic'
    charge_satur_val = 30*max(abs(qp),abs(qn))*5/L**2
...
for v in [-70.0]:
    run(pot0=v,x0=0.00,y0=0,r0=40,vx0=0.0,vy0=0.0,px0=0.0,py0=0)
